...
// ADD THIS INTERFACE FOR SKITCH PHOTOS
export interface ISkitchPhoto {
  url: string;
  publicId: string;
...
export interface IProject extends Document {
  ...
  mitTechId?: mongoose.Types.ObjectId;
  estimatorId?: mongoose.Types.ObjectId;
  companyId: mongoose.Types.ObjectId;

  // NEW: Skitch photos array
  skitchPhotos: ISkitchPhoto[];
...
const SkitchPhotoSchema: Schema = new Schema({
  url: {
    type: String,
    required: true,
  },
...
const ProjectSchema: Schema = new Schema(
  {
    ...
    // NEW: Skitch photos array
    skitchPhotos: [SkitchPhotoSchema],
...
ProjectSchema.index({ mitTechId: 1 });
